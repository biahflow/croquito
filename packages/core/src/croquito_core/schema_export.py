...
from croquito_core.models import SCENE_SCHEMA_VERSION, SceneRevision


def schema_text() -> str:
    schema = SceneRevision.model_json_schema()
    schema["$id"] = f"https://schemas.croquito.local/scene/{SCENE_SCHEMA_VERSION}.json"
    schema["title"] = "Croquito Scene Revision"
