...
(`croquitodxf_worker.valuation.parity`): fora da cadeia de medição, fora do CI, não
...
Números são convertidos com `canonical_number` (`croquitodxf_valuation.canonical`), a
...
from croquitodxf_valuation.canonical import canonical_number
from croquitodxf_valuation.catalog import file_sha256
from croquitodxf_valuation.errors import ValuationValidationError
from croquitodxf_valuation.models import ExactDecimal, Valuation, ValuationContractModel
from croquitodxf_valuation.template import BulletinLayout, SheetColumns, WorkbookTemplate
