...
from croquitodxf_valuation.models import PriceCatalog, PriceCatalogEntry, ValuationContractModel
...
from croquitodxf_valuation.template import CatalogLayout, WorkbookTemplate

_CATALOG_ID_NAMESPACE: Final = uuid5(NAMESPACE_URL, "https://croquitodxf.local/valuation/catalog")
_BLANK_CHARS: Final = " \t\r\n\xa0\u202f\u2007"
...
class DomainSynonyms(ValuationContractModel):
    ...
    (`packages/valuation/src/croquitodxf_valuation/data/sco-synonyms-v1.json`,
...
def default_domain_synonyms() -> DomainSynonyms:
    ...
    """
    payload = (
        resources.files("croquitodxf_valuation")
...
class LegendNoiseList(ValuationContractModel):
    ...
    A tabela é carregada de um seed versionado
    (`packages/valuation/src/croquitodxf_valuation/data/sco-legend-noise-v1.json`,
