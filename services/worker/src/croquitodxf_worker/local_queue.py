...
from croquitodxf_worker.artifact_store import WorkerArtifactStore
from croquitodxf_worker.chat import build_chat_text_payload, chat_unknown_references
from croquitodxf_worker.criteria import ScopeCriterion
from croquitodxf_worker.dxf import export_scene_package
from croquitodxf_worker.provider_review import (
...
from croquitodxf_worker.rectangle_solver import SolverResidual
from croquitodxf_worker.review import ReviewPacket
from croquitodxf_worker.review_store import (
...
class LocalWorkerSettings:
    ...
    artifact_bucket: str = "croquitodxf-local-artifacts"
    ...
    def from_environment(cls, *, require_queue: bool = True) -> LocalWorkerSettings:
        ...
        required = {
            "database_url": os.getenv("CROQUITODXF_DATABASE_URL"),
            "aws_endpoint_url": os.getenv("CROQUITODXF_AWS_ENDPOINT_URL"),
        }
        if require_queue:
            required["queue_url"] = os.getenv("CROQUITODXF_PROCESSING_QUEUE_URL")
        ...
        return cls(
            ...
            real_providers_enabled=os.getenv("CROQUITODXF_REAL_PROVIDERS_ENABLED", "").lower()
            in {"1", "true", "yes"},
