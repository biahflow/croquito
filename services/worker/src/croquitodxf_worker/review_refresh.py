...
regra da API (`croquitodxf_worker.proposal_calibration.revalidate_calibration`). Uma
...
from croquitodxf_core.models import Entity, Issue, IssueSeverity, SceneRevision
...
from croquitodxf_worker.review import ReviewPacket, file_sha256
