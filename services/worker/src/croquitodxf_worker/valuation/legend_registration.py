...
Espelho de `croquitodxf_worker.vision.register_to_ink`: mesma disciplina de assentamento
...
from croquitodxf_valuation.takeoff import PlateBox, TakeoffItem, TakeoffPacket
