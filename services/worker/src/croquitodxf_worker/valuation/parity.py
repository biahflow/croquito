...
- não interpreta fórmula fora da gramática fechada da auditoria (`GRAMMAR_PATTERNS`, de
  `croquitodxf_valuation.canonical`): `VLOOKUP`, `IF`, referência a outra aba ou a outro
...
from croquitodxf_valuation.canonical import CELL_REF_RE, GRAMMAR_PATTERNS, expand_range
