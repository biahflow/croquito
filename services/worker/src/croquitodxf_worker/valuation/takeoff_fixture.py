...
from croquitodxf_valuation.catalog import file_sha256, normalize_unit
...
from croquitodxf_worker.valuation.plate import PLATE_EXTRACTOR_VERSION, PlateArtifacts
