...
from croquitodxf_valuation.assignment import CodeAssignmentBatch, CodeAssignmentInput
from croquitodxf_valuation.calc import CalcBlockPlan, CalcBuildResult, CalcPlan, ItemCalcPlan
from croquitodxf_valuation.catalog import parse_money
...
_SYNTHETIC_NAMESPACE: Final = uuid5(NAMESPACE_URL, "https://croquitodxf.local/valuation/synthetic")
...
_MULTI_NAMESPACE: Final = uuid5(
    NAMESPACE_URL, "https://croquitodxf.local/valuation/synthetic-multi"
)
