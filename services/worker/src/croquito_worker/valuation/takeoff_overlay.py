...
Espelho do `render_review_overlay` das cotas (`croquito_worker.review`): mesmas cores
...
(`croquito_worker.element_labels.place_labels`: nome completo só onde cabe, resto vira
...
from croquito_valuation.takeoff import PlateBox, TakeoffItem, TakeoffItemStatus, TakeoffPacket
