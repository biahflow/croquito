...
from croquito_valuation.assignment import CodeSuggestionSet, SuggestionConfig
...
from croquito_worker.extraction_eval import ExtractionNotAllowlistedError, authorize_page
...
from croquito_worker.valuation.takeoff_eval import matches_gabarito
...
def _write_plate_manifest(output_dir: Path, plate: PlateArtifacts) -> Path:
    """Manifest da prancha sintética, no formato que `croquito-demo ingest` publica.
