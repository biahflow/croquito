...
| F-048 | HIGH | READY_FOR_PLANNING | [Auditoria de medição de terceiros: o furo que ninguém procurou](../features/F-048-auditoria-de-medicao-de-terceiros/feature.md) — contrato em 2026-09-05, **prioridade `HIGH` por ato humano no mesmo dia**: o motor já existe e já achou dinheiro errado em arquivo real (os 8 erros de centavo do MAPÃO do cliente viram o caso de aceite). Faltam rota `/v1`, artefato de relatório e tela; **o unknown 2 foi respondido em 2026-09-05 — produto avulso**, jornada própria que não exige projeto nem contrato (é o que alcança quem ainda não é cliente); **Design Approval Package aprovado em 2026-09-05** (revisão 1) — todos os gates cumpridos, pronta para o Planner |
