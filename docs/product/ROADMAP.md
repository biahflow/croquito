...
| F-046 | HIGH | READY_FOR_PLANNING | [A praça de várias pranchas](../features/F-046-praca-de-varias-pranchas/feature.md) — ADR-0057 aceito em 2026-08-28; [Design Approval Package rev. 1](../features/F-046-praca-de-varias-pranchas/mock/README.md) produzido, **pendente de aprovação humana** |
| F-047 | HIGH | READY_FOR_PLANNING | [O quantitativo nasce da cena aprovada](../features/F-047-quantitativo-da-cena-aprovada/feature.md) — ADR-0058 aceito em 2026-08-28 com emenda; depende de F-046; pende o Design Approval Package |
...
| 20 | Próximo — medição além do v1 / Criação e gestão de re-ratificações (RE-RA); no v1 elas são apenas lidas para o cálculo de saldo. | EM ESPECIFICAÇÃO | [Roadmap](ROADMAP.md), [F-040](../features/F-040-re-ra-e-medicao-seguinte/feature.md), [ADR-0056](../adr/0056-re-ra-declarada-e-o-consolidado-da-medicao-seguinte.md) | O efeito da RE-RA sobre o saldo já está entregue e validado desde o M8 (`validate_amendments`); o que falta é procedência, caminho de criação e a **medição seguinte**, que não existe na `/v1` — sem ela a RE-RA só seria declarável no período 1. A [F-040](../features/F-040-re-ra-e-medicao-seguinte/feature.md) ataca os três, e o ADR-0056 aguarda aceite humano. |
