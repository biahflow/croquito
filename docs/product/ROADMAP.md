...
Status: Active  
Responsável: Product  
Última revisão: 2026-08-28 (**F-045 registrada** `READY_FOR_PLANNING`/`HIGH` por decisão do
dono: a etapa de códigos não tem como desfazer um par `(item, código)` confirmado, e o único
...
| F-045 | HIGH | READY_FOR_PLANNING | [Desfazer um código confirmado](../features/F-045-desfazer-codigo-confirmado/feature.md) |
