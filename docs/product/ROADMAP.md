...
| F-051 | HIGH | READY_FOR_HUMAN_REVIEW | [A cota-balão encontra seu elemento: identidade declarada na revisão](../features/F-051-cota-balao-encontra-seu-elemento/feature.md) — nasce da [issue #139](https://github.com/biahflow/croquito/issues/139) (revisão real do Toca); caminho de arquitetura escolhido pelo dono em 2026-09-04 ([ADR-0063](../adr/0063-identidade-de-elemento-nasce-na-revisao.md), **Accepted em 2026-09-04**); Design Approval Package revisão 1 **aprovado em 2026-09-04** ([pacote](../features/F-051-cota-balao-encontra-seu-elemento/mock/README.md)); as 7 tarefas do [plano](../features/F-051-cota-balao-encontra-seu-elemento/plan.md) foram entregues em 2026-09-04 ([evidência](../features/F-051-cota-balao-encontra-seu-elemento/evidence.md), validação de navegador incluída) — falta só o **gate 3**, o aceite contra o croqui real do Toca ([roteiro](../features/F-051-cota-balao-encontra-seu-elemento/evidencia/ROTEIRO-GATE-3.md)) |
