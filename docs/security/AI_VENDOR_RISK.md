...
Última revisão: 2026-08-22 (Groq entra como fornecedor de transcrição de voz de campo —
F-032 T13, decisão humana de fornecedor, termos pendentes de confirmação na abertura da
conta; antes: Gemini e Mistral como fornecedores de eval por CLI, fora da suite hospedada;
AWS Bedrock/Textract seguem fora da tabela ativa)
