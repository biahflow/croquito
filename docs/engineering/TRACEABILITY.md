...
| VAL-07 | Valuation Context (`serve`/`local_server.py` + `apps/medicao`); FDD medição | ADR-0016/0020 | `tests/worker/test_valuation_local_server.py`; testes de `apps/medicao` (vitest); homologação real da orçamentista pendente (ato humano) |
